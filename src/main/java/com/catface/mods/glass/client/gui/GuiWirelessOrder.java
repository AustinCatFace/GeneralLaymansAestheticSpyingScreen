...
public class GuiWirelessOrder extends GuiScreen
{
    ...
    {
        CFGlass.channel.sendToServer(new PacketWirelessOrder(master.getPos(), channels));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        mc.getRenderItem().renderItemAndEffectIntoGUI(new ItemStack(CFGlass.blockGlass, 1, 1), 0, 0);
