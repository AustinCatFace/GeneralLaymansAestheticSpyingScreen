...
public class GuiChannelSetterProjector extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        for(String s : CFGlass.eventHandlerClient.terminalLocations.keySet())
        {
    ...
    public void confirmSelection(boolean doubleClick)
    {
        ...
        CFGlass.channel.sendToServer(new PacketSetChannel(master.getPos(), channels.get(index)));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        mc.getRenderItem().renderItemAndEffectIntoGUI(new ItemStack(CFGlass.blockGlass, 1, 2), 0, 0);
