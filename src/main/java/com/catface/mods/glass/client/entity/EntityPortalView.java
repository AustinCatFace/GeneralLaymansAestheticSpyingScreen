...
public class EntityPortalView extends Entity
{
    ...
    public PortalEntity tiedEntity = null;

    public EntityPortalView(World worldIn)
    {
        super(worldIn);
    }

    public EntityPortalView(World worldIn,PortalEntity portal, double x, double y, double z, EnumFacing facing)
    {
        super(worldIn);
