...
import com.catface.mods.glass.common.block.*;
...
public class EventHandlerServer
{
    ...
    public void onRegisterBlock(RegistryEvent.Register<Block> event)
    {
        ...
        CFGlass.blockBoxPortal = (new BlockBoxPortal(Material.GLASS)).setRegistryName(CFGlass.MOD_ID, "block_box_portal").setUnlocalizedName("glass.block.box.portal").setHardness(0.8F);
        ...
        event.getRegistry().register(CFGlass.blockBoxPortal);
    }
    ...
    public void onRegisterItem(RegistryEvent.Register<Item> event)
    {
        ...
        event.getRegistry().register(new ItemBlock(CFGlass.blockBoxPortal).setRegistryName(CFGlass.blockBoxPortal.getRegistryName()));
    }
